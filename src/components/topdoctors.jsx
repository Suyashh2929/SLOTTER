...
const topdoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-6 text-gray-900 md:text-10 '>
        ...
        <button onClick={()=>{navigate('/doctors'); scrollTo(0,0)}} className='bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10 font-medium '>more</button>
    </div>
  )
}
